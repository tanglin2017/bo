...
?> 
                <li class="">
                    <div> <i><?php echo $v['title']?></i> <span></span> <font><small>招聘人数：<?php echo $v['e_title']?></small>  <small>工作地点：<?php echo $v['linkurl']?></small> <small>学历：<?php echo $v['info_author']?> </small> <small>职位性质：<?php echo $v['color']?></small> </font> </div>
            ...
            <div class="page">
<a href='job.php?ye=<?php $yes=$yeshu-1;echo $yes<1?1:$yes;?>'>上一页</a>
<?php 
for ($i=1;$i<=$zongyeshu;$i++){
?>
<a <?php if ($i==$yeshu){echo 'class="ahover"';}?> href='job.php?ye=<?php echo $i;?>'><?php echo $i?></a>
<?php }?>
<a href='job.php?ye=<?php $yex=$yeshu+1;echo $yex>$zongyeshu?$zongyeshu:$yex;?>'>下一页</a>
