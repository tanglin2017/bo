...
<head>
<?php 
$sqlguanjian="select * from info_lm where id_lm=12";
...
$retn=$db->query($sqln)->row('array');
?>
    <a href="bgfx.php?lm=12" class="now"><?php echo $retn['title_lm']?></a>
    </div>
    </div>
<section class="about">
    <div class="wrap">
<?php 
$sqln="select * from info_co where lm=12 and pass=1 order by wtime desc limit 1";
$retn=$db->query($sqln)->row('array');
?>
