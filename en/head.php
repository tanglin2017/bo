<header class="pageHeader tration03">
    <div class="wrap fix">
        <div class="head_r r">
            <div class="top_bar">
                <ul class="fix">
                    <li class="hd_link"> <a href="https://www.blueoceancenter.com/login.html#" target="_blank">Login</a></li>
                    <li class="hd_join"> <a href="https://www.blueoceancenter.com/login.html#" target="_blank">Register</a></li>
<?php 
...
?>
                    ...
                    <li class="nav_language"> <i class="ico"></i>EN <i class="ico ico1_2"></i>
                        <div class="language_cover">
                            <ul>
                                <li><a href="../index.php?yu=1">简体中文</a></li>
                                <li><a href="index.php?yu=1">English</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
    ...
    <div class="search_conver">
        <form action="new.php" method="get" name="topSearchForm" id="topSearchForm">
            <div class="search_box">
                <input class="search_select search_main" id="typeSelect" name="type" readonly="readonly" value="News">
                <input type="text" name="ss" class="serach_inp search_main" />
                <button class="search_btn search_main" type="submit">Search</button>
            </div>
        </form>
    </div>
</header>
