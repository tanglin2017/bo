...
<?php $lm=(int)$_GET['lm'];?> 
    ...
    <SELECT name="lm" onChange="changeCat();" id="lm" class="dfinput" >
                                        <?php
//添加信息时显示栏目过程
                                        $sql = "select id_lm, title_lm, fid, xia, add_xx from info_lm where id_lm=5 order by px";
...
//添加信息时显示栏目子过程
	...
	<li id="dis_img_sl"><label>略缩图片</label> <input name="img_sl" type="file" id="img_sl" class="dfinput"><span id="jycc33">(建议最佳图片尺寸：630*420)</span></li>
