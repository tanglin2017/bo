...
document.form1.fid.value=<?php echo $res->fid;?>;
    ...
    <li <?php if($id!=6){?>style="display: none;"<?php }?>><label>图片标题</label><input name="title_en" value="<?php echo $res->title_en;?>" type="text" class="dfinput" /></li>
    <li <?php if($id!=6){?>style="display: none;"<?php }?>><label>栏目图片</label>
    <?php 
			if($res->img_url != '')
			{
			?>
	...
	<li <?php if($id!=18){?>style="display: none;"<?php }?>><label>栏目简介</label><textarea  id="jianjie" class="dfinput" name="jianjie" style="width:345px;height:100px;"><?php echo htmlspecialchars($res->jianjie,ENT_QUOTES);?></textarea></li>
    <li <?php if($id!=18){?>style="display: none;"<?php }?>><label>应聘方式</label><textarea  id="neirong"  class="dfinput" name="neirong" style="width:345px;height:50px;"><?php echo htmlspecialchars($res->neirong,ENT_QUOTES);?></textarea></li>
