...
<body>
    ...
    <li><a href="../column6/defaultco.php">信息列表</a></li>
    </ul>
    </div>
...
<?php $lm=(int)$_GET['lm'];?> 
    ...
    <SELECT name="lm" onChange="changeCat();" id="lm" class="dfinput" >
                                        <?php
//添加信息时显示栏目过程
                                        $sql = "select id_lm, title_lm, fid, xia, add_xx from info_lm where fid=6 order by px";
...
//添加信息时显示栏目子过程
    ...
    <li id="dis_e_title" style="display:none;"><label id="biaoti">招聘人数</label><input name="e_title" id="e_title" type="text" class="dfinput" value=""/></li>
    <li id="dis_uselink" style="display:none;">
    <label>工作地点</label><input name="linkurl" type="text" class="dfinput" value="" /><br/>
    <label>学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;历</label><input name="info_author" type="text" class="dfinput" value="" /><br/>
    <label>职业性质</label><input name="color" type="text" class="dfinput" value="" />
    </li>
	...
	<li id="dis_img_sl"><label>略缩图片</label> <input name="img_sl" type="file" id="img_sl" class="dfinput"><span id="jycc33">(建议最佳图片尺寸：290*180)</span></li>
