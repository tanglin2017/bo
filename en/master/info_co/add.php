...
//添加信息时显示栏目子过程
    ...
    <li id="dis_key2" style="display:none;"><label>网站描述</label><textarea class="dfinput"  id="description" name="description" style="width:345px;height:100px;"></textarea></li>
	...
	<li><label>录入时间</label> <input name="wtime" type="text" id="wtime" value="<?php echo date("Y-m-d H:i:s"); ?>" maxlength="50" class="dfinput">              时间格式为&ldquo;年-月-日 时:分:秒&rdquo;，如：<font color="#0000FF">2003-55-12 12:32:47</font></li>
