...
<body>
    ...
    <li><a href="../column1/defaultco.php">信息列表</a></li>
    </ul>
    </div>
...
$('#lm').val(<?php echo $res->lm;?>)
    ...
    <li id="dis_e_title" <?php if(!$dis_lm->e_name) echo "style='display:none;'"; ?>>
    <label>副标题一</label><input name="e_title" id="e_title" type="text" class="dfinput" value="<?php echo $res->e_title;?>"/><br/>
    <label>副标题二</label><input name="info_author" type="text" class="dfinput" value="<?php echo $res->info_author;?>" />
    </li>
	...
	<li id="dis_f_body" <?php if(!$dis_lm->f_body) echo "style='display:none;'"; ?>><label>信息精要</label><textarea  id="f_body" name="f_body" class="dfinput" style="width:800px;height:200px;"><?php echo htmlspecialchars($res->f_body,ENT_QUOTES);?></textarea></li>
	...
	<span>(建议最佳图片尺寸：<?php if($lm==22){echo '1903*1004';}
	elseif ($lm==21){echo '80*80';}
	elseif ($lm==23){echo '400*240';}
	elseif ($lm==25){echo '588*345';}
	elseif ($lm==26){echo '2048*434';}
	?>)</span>
