...
<head>
<?php 
$sqlguanjian="select * from info_lm where id_lm=9";
...
$retn=$db->query($sqln)->row('array');
?>
    <a href="shfw.php?lm=9" class="now"><?php echo $retn['title_lm']?></a> 
<?php 
...
<section class="about_zhongw">
    <div class="wrap">
        <ul>
<?php 
$sql="select * from info_co where lm=9 and pass=1 order by px";
