...
<a href='new.php?ye=<?php $yes=$yeshu-1;echo $yes<1?1:$yes;?>&ss=<?php echo $ss;?>'>Prev</a>
<?php 
for ($i=1;$i<=$zongyeshu;$i++){
?>
<a <?php if ($i==$yeshu){echo 'class="ahover"';}?> href='new.php?ye=<?php echo $i;?>&ss=<?php echo $ss;?>'><?php echo $i?></a>
<?php }?>
<a href='new.php?ye=<?php $yex=$yeshu+1;echo $yex>$zongyeshu?$zongyeshu:$yex;?>&ss=<?php echo $ss;?>'>Next</a>
