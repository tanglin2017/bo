...
<?php $lm=(int)$_GET['lm'];?> 
    ...
    <SELECT name="lm" onChange="changeCat();" id="lm" class="dfinput" >
                                        <?php
//添加信息时显示栏目过程
                                        $sql = "select id_lm, title_lm, fid, xia, add_xx from info_lm where id_lm in(20,22) order by px";
...
//添加信息时显示栏目子过程
    ...
    <li id="dis_e_title" style="display:none;">
    <label>副标题一</label><input name="e_title" id="e_title" type="text" class="dfinput" value=""/><br/>
    <label>副标题二</label><input name="info_author" type="text" class="dfinput" value="" />
    </li>
    <li id="dis_uselink" style="display:none;"><label>连接地址</label><input name="linkurl" type="text" class="dfinput" value="" /></li>
    
	<li id="dis_f_body" style="display:none;"><label>信息精要</label><textarea  id="f_body" name="f_body" class="dfinput" style="width:800px;height:200px;"></textarea></li>
	...
	<li id="dis_img_sl"><label>略缩图片</label> <input name="img_sl" type="file" id="img_sl" class="dfinput"><span>(建议最佳图片尺寸：1903*1004)</span></li>
