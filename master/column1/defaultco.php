...
<div class="place">
	...
	<li><?php
	//显示栏目
$id_lm = isset($_GET["id_lm"]) ? $_GET["id_lm"] : 1;
...
{
	$sql = "select id_lm,title_lm,fid from info_lm where fid=1  order by px";
}
else
{
...
?>                </TD>
                ...
                <TD align=center> 
				<A href="editco.php?id=<?php echo $rs->id; ?>&id_lm=<?php echo $rs->lm;?>" >修改</A><?php if($rs->lm==20 || $rs->lm==22){?>|
