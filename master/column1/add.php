...
<li><label>英文名称</label><input name="title_en" type="text" class="dfinput"/></li>
<li><label>栏目图片</label><input name="img_url" type="file" id="img_url"></li>
<li><label>栏目图片2</label><input name="simg_url" type="file" id="simg_url"></li>
...
<li><label>栏目简介</label><textarea  id="jianjie" name="jianjie" style="width:800px;height:200px;visibility:hidden;"></textarea></li>
<li><label>栏目内容</label><textarea  id="neirong" name="neirong" style="width:800px;height:400px;visibility:hidden;"></textarea></li>
...
<li style="display: none;"><label>高级选项</label><cite><input name="gao" type="checkbox" id="gao" value="yes" onClick="checkgao()">
	...
	<div id="gaoji" style="display:none;">
      ...
      <tr>
        <td height="30">
          <input type="radio" name="f_body" id="f_body" value="1" checked>
          是
          <input name="f_body" type="radio" id="f_body" value="0">
        否 有简要介绍</td>
      </tr>
      <tr>
        <td height="30">
          <input name="z_body" type="radio" id="z_body" value="1">
          是
          <input type="radio" name="z_body" id="z_body" value="0" checked>
        否 有详细介绍</td>
      </tr>
      <tr>
        <td height="30">
          <input name="img_sl" type="radio" id="img_sl" value="1" checked>
          是
          <input name="img_sl" type="radio" id="img_sl" value="0">
        否 有缩略图片</td>
      </tr>
      <tr>
        <td height="30">
     ...
     <tr>
        <td height="30">
          <input type="radio" name="info_from" id="info_from" value="1" checked>
          是
          <input name="info_from" type="radio" id="info_from" value="0">
        否 有多图展示</td>
      </tr> 
      <tr>
        <td height="30">
