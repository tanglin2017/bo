...
<li style="display: none;"><label>栏目图片</label><input name="img_url" type="file" id="img_url"><span id="jycc33">(建议最佳图片尺寸：1920*980)</span></li>
<li style="display: none;"><label>栏目banner</label><input name="simg_url" type="file" id="simg_url"><span>(建议最佳图片尺寸：1920*500)</span></li>
...
<li style="display: none;"><label>高级选项</label><cite><input name="gao" type="checkbox" id="gao" value="yes" onClick="checkgao()">
	...
	<div id="gaoji" style="display:none;">
      ...
      <tr>
        <td height="30">
          <input name="e_name" type="radio" id="e_name1" value="1">
          是
          <input type="radio" name="e_name" id="e_name2" value="0" checked>
        否 有英文名称</td>
      </tr>
      <tr>
        <td height="30"><label>
          <input name="xia" type="radio" id="xia1" value="1">
          是
          <input type="radio" name="xia" id="xia2" value="0" checked>
        否 有下级栏目</label></td>
      </tr>
      <tr>
        <td height="30"><label>
      ...
      <tr>
        <td height="30">
          <input name="img_sl" type="radio" id="img_sl1" value="1">
          是
          <input name="img_sl" type="radio" id="img_sl2" value="0" checked>
        否 有缩略图片</td>
      </tr>
      <tr>
        <td height="30">
