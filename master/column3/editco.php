...
$('#lm').val(<?php echo $res->lm;?>)
    ...
    <li id="dis_e_title" <?php if(!$dis_lm->e_name) echo "style='display:none;'"; ?>><label>英文</label><input name="e_title" id="e_title" type="text" class="dfinput" value="<?php echo $res->e_title;?>"/></li>
