...
$('#lm').val(<?php echo $res->lm;?>)
    ...
    <li id="dis_e_title" <?php if(!$dis_lm->e_name) echo "style='display:none;'"; ?>><label><?php if($lm==18){?>招聘人数<?php }elseif ($lm==19) {echo '文章来源';}?></label><input name="e_title" id="e_title" type="text" class="dfinput" value="<?php echo $res->e_title;?>"/></li>
    <li id="dis_uselink" <?php if(!$dis_lm->uselink) echo "style='display:none;'"; ?>>
    <label>工作地点</label><input name="linkurl" type="text" class="dfinput" value="<?php echo $res->linkurl ?>" /><br/>
    <label>学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;历</label><input name="info_author" type="text" class="dfinput" value="<?php echo $res->info_author ?>" /><br/>
    <label>职业性质</label><input name="color" type="text" class="dfinput" value="<?php echo $res->color ?>" />
