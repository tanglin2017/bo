...
<body>
    ...
    <li><a href="../info_lm/default.php">信息栏目</a></li>
    </ul>
    </div>
...
<?php
//添加信息时显示栏目过程
$sql = "select id_lm, title_lm, fid, xia, add_xx from info_lm where fid=0 order by px desc";
...
$('#lm').val(<?php echo $res->lm;?>)
    ...
    <li id="dis_key2" <?php if(!$dis_lm->web_key) echo "style='display:none;'"; ?>><label>网站描述</label><textarea class="dfinput"  id="description" name="description" style="width:345px;height:100px;"><?php echo $res->description;?></textarea></li>
	...
	<li id="dis_bimg_sl" <?php if(!$dis_lm->bimg_sl) echo "style='display:none;'"; ?>><label>上传文件</label> 
