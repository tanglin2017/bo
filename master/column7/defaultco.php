...
<div class="place">
	...
	<li><?php
	//显示栏目
$id_lm = isset($_GET["id_lm"]) ? $_GET["id_lm"] : 7;
...
{
	$sql = "select id_lm,title_lm,fid from info_lm where fid=7  order by px";
}
else
{
...
?>                </TD>
				...
				<?php if ( $rs->tuijian ){?>
                <a href="actionco.php?act=tuijian1&id=<?php  echo $rs->id; ?>" >取消</a>
				<?php }else{?>
				<a href="actionco.php?act=tuijian2&id=<?php  echo $rs->id; ?>" >推荐</a>
				<?php } ?>	
